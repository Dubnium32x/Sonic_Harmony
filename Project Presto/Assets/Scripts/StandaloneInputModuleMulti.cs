...
{
    [AddComponentMenu("Event/Standalone Input Module (Multiple Buttons per Action)")]
    /// <summary>
    ...
    public class StandaloneInputModuleMulti : PointerInputModule
    {
        ...
        {
            get { return m_SubmitButtons; }
            set { m_SubmitButtons = value; }
        }

        /// <summary>
        /// Input manager name for the 'cancel' button.
        /// </summary>
        public string[] cancelButtons
        {
            get { return m_CancelButtons; }
            set { m_CancelButtons = value; }
        }
